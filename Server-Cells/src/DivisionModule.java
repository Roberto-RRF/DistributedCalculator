...
public class DivisionModule {
    ...
    public DivisionModule(String serverName)
    {
        ...
        public void run() {
            ...
            while (socket.isConnected()) {
                try {
                    ...
                    if (incoming.getTipoOperacion() == (short) 4)
                    {
                        System.out.println("Division module received package");
